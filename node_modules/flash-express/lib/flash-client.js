...
style.success = "color:black;background-color: rgb(209, 184, 253);border-radius: 5px;border: 0px green solid; padding: 10px 100px; ";
style.info = "color:blue;background-color: rgba(26, 22, 242, 0.42);border-radius: 5px;border: 0px blue solid;";
style.warn = "color:coral;background-color: rgba(255, 250, 80, 0.87);border-radius: 5px;border: 0px coral solid;";
style.error = "color:red;background-color: rgba(255, 0, 0, 0.42);border-radius: 5px;border: 0px red solid;";
...
flash.prototype.show = function (flash) {
    ...
    setTimeout(this.fadeOut, flash.option.duration = 3000, flashDiv);
    return flashDiv;
}
